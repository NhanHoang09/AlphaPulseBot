...
• **Ưu điểm:** Độ chính xác cao, kiến thức cập nhật, trả lời chi tiết
    ...
    # REMOVED: vn_command() - Trùng lặp với stock_command()
    
    # REMOVED: us_command() - Thị trường Mỹ không khả dụng
    ...
    # REMOVED: analyze_stock() - Trùng lặp với analyze_stock_with_ai()
...
"""
    ...
    # REMOVED: analyze_vn_stock() - Trùng lặp với analyze_vn_stock_with_ai()
...
"""
    ...
    # REMOVED: analyze_us_stock() - Trùng lặp với analyze_us_stock_with_ai()
...
"""
    ...
    # REMOVED: send_welcome_message() - Trùng lặp với start_command()
...
"""
    ...
    def run(self):
        ...
        application.add_handler(CommandHandler("model_status", self.model_status_command))
